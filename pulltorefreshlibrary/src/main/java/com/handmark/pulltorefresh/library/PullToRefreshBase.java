...
import com.handmark.pulltorefresh.library.internal.CustomFooterLoadingLayout;
import com.handmark.pulltorefresh.library.internal.CustomHeaderLoadingLayout;
	...
	public static enum AnimationStyle {
		...
		LoadingLayout createLoadingLayout(Context context, Mode mode, Orientation scrollDirection, TypedArray attrs) {
			...
			if (mode == Mode.PULL_FROM_END) {
				...
				return new CustomFooterLoadingLayout(context, mode, scrollDirection, attrs);
			} else {
				switch (this) {
					case ROTATE:
					default:
//					return new RotateLoadingLayout(context, mode, scrollDirection, attrs);
						return new CustomHeaderLoadingLayout(context, mode, scrollDirection, attrs);
					case FLIP:
